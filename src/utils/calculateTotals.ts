export const calculateTotals = (p: any, es: any, ef: any): object => {
  const total_frontend_days = ef.reduce(
    (a: any, b: any) => a + b.frontend_days,
    0
  );
  const total_backend_days = ef.reduce(
    (a: any, b: any) => a + b.backend_days,
    0
  );
