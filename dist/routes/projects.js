...
router.patch("/:id", projects_1.patchProject);
router.delete("/:id", isAuth_1.authMiddleware, projects_1.deleteProject);
router.post("/:id/estimated_features", 
// authMiddleware,
// featureValidationRules(),
// validate,
estimated_feature_1.postProjectFeature);
router.patch("/:id/estimated_features/:featureId", 
// authMiddleware,
// featureValidationRules(),
// validate,
estimated_feature_1.patchProjectFeature);
